...
$js = '';
$js.='<script src="'.$mp_url.$fc.'/lib/moment.min.js"></script>
<script src="'.$mp_url.$fc.'/fullcalendar.js"></script>
<script src="'.$mp_url.$fc.'/lang-all.js"></script>';
$js .= "<script>
...
$modx->regClientCSS('<link href="'.$mp_url.$fc.'/fullcalendar.css" rel="stylesheet" />');
